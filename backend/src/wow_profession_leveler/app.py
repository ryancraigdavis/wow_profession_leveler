...
class BlizzardAPI:
    ...
    def get_ah_data(self, realm_id, namespace, region, faction_id):
        ...
        params = {"namespace": namespace, "locale": "en_US", "access_token": self.token}
...
async def process_data():
    ...
    # ah_data = blizzard_api.get_ah_data(realm, namespace, region, faction_id)
    ah_data = blizzard_api.get_ah_data(4384, "dynamic-classic-us", "us", 6)
